...
private slots:
    ...
    void on_BuyAV_clicked();
    void on_SellAVBTN_clicked();
    void on_SellBidcomboBox_currentIndexChanged(const QString &arg1);
    void on_Sell_Max_Amount_clicked();
    void on_UnitsInputAV_textChanged(const QString &arg1);
    ...
    QString BuyAV(QString OrderType, double Quantity, double Rate);
    QString SellAV(QString OrderType, double Quantity, double Rate);
