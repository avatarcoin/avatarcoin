...
!define URL http://www.avatarcoin.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/avatarcoin.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\avatarcoin-qt.exe
...
OutFile avatarcoin-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/avatarcoin-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/avatarcoind.exe
    ...
    #Delete /REBOOTOK $INSTDIR\avatarcoin.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\avatarcoin-qt.exe
